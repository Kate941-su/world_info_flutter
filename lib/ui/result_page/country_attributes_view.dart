...
import 'package:rate_converter_flutter/ad/interstitial_ad_manager.dart';
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    _CountryAttributeUnit(
                      ...
                      rightAttr:
                          '${rightCountryAttr.urbanPopulation ?? noData}',
                    ),
                    _CountryAttributeUnit(
                    ...
                    _CountryAttributeUnit(
                      ...
                      leftAttr:
                          '${leftCountryAttr.tourists?.toInt() ?? noData}',
                      rightAttr:
                          '${rightCountryAttr.tourists?.toInt() ?? noData}',
                    ),
                    _CountryAttributeUnit(
                    ...
                    _CountryAttributeUnit(
                      ...
                      rightAttr:
                          '${rightCountryAttr.infantMortality ?? noData}',
                    ),
                    _CountryAttributeUnit(
                    ...
                    TextButton(
                        onPressed: () {
                          context.read<InterstitialAdRepository>().showAd();
                        },
            ...
            url != null
                ? InkWell(
                    onTap: () {
                      ...
                      // if (adManger.interstitialAd != null) {
                      //   adManger.interstitialAd!.show();
                      //   // launchUrlString(url!)
